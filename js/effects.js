...
puller.addEventListener("click",      function() {
 ...
 let pull1 = document.querySelector('.main__section__5');
 let button_3 = document.querySelector('.button__3');
 pull1.style.display = 'none'

 button_3.addEventListener("click",      function() {

    if(pull1.style.display == 'none')  pull1.style.display = 'flex';
    else pull1.style.display = 'none'
